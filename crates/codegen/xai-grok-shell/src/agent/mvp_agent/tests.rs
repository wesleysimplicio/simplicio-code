Warning: truncated output (original token count: 45809)
Total output lines: 4511
...
mod eligibility_gates {
    ...
    /// Gate 4 (git root) requires a real filesystem and is covered by…5809 tokens truncated…  });
    assert!(
