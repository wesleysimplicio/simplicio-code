...
/// Default identity in the primary system prompt (`You are Simplicio Code`).
pub const DEFAULT_SYSTEM_PROMPT_LABEL: &str = "Simplicio Code";
...
mod tests {
    ...
    fn trimmed_prompts_no_redundant_identity() {
        ...
        for (name, prompt) in [
            ...
            assert!(
                !prompt.contains("You are a Simplicio Code agent"),
