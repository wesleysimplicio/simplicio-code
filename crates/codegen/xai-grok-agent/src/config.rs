...
/// Simplicio Code + plan mode toolset.
///
...
/// Simplicio Code + plan mode toolset WITHOUT subagent tools.
///
...
/// Default Simplicio Code toolset + `ask_user_question`.
///
...
impl AgentDefinition {
    ...
    pub fn default_grok_build() -> Self {
        Self::base(
            ...
            "Simplicio Code agent for software engineering tasks.",
        )
    }
    /// Simplicio Code Concise agent definition — concise output format for SFT/RL.
    pub fn grok_build_concise() -> Self {
        Self {
            ...
            ..Self::base(
                ...
                "Simplicio Code agent with concise output format.",
            )
        }
    }
    /// Simplicio Code agent with plan mode tools.
    pub fn grok_build_plan() -> Self {
        Self {
            tool_config: grok_build_plan_toolset(),
            ..Self::base(
                BuiltinAgentName::GrokBuildPlan,
                "Simplicio Code agent with plan mode support.",
            )
        }
    }
    /// Simplicio Code + plan mode WITHOUT subagent tools.
    pub fn grok_build_plan_no_subagents() -> Self {
        Self {
            ...
            ..Self::base(
                ...
                "Simplicio Code agent with plan mode (no subagents).",
            )
        }
    }
    /// Default Simplicio Code agent with the `ask_user_question` tool.
    pub fn grok_build_ask_user() -> Self {
        Self {
            tool_config: grok_build_ask_user_toolset(),
            ..Self::base(
                BuiltinAgentName::GrokBuildAskUser,
                "Simplicio Code agent with ask-user-question tool.",
            )
        }
    }
    pub fn codex() -> Self {
    ...
    /// Simplicio Code Orchestrator — GBL model with full GrokBuild tools
